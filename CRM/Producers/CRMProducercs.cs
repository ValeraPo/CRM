...
{
    public class CRMProducercs
    {
        public class CRMProduser : ICRMProducers
        {
            private readonly ILeadService _leadService;
            private readonly IAccountService _accountService;
            private readonly ILogger<CRMProduser> _logger;

            public CRMProduser(ILeadService leadService, IAccountService accountService,
                ILogger<CRMProduser> logger)
            {
